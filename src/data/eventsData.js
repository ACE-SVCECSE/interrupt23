const events =[
    ...
    },
    {
        ...
        eventDetails: {
            ...
            rounds:[
                " Qualifier: This is an MCQ round related to programming concepts, syntax and semantics. The top 10 teams will be selected for Round 2 based on speed and the number of correct answers.",
                " Cross-Bugs: This is a debugging round where a crossword puzzle will be provided. The task is to find the final answer from the crossword, which reveals the HackerEarth link to the participants. Both participants will solve the crossword, but only one will be allowed to debug at a time, and he/she will be swapped with his/her teammate every 10 minutes."
            ],
            judging: "The team that solves the crossword and debugs all the questions in the HackerEarth link first will be the winner.",
            deadline:"5th May 2021, 11:59 p.m",
            registerLink: "",
            contact: {
                "Pooja T:" : "+91 63805 09827",
